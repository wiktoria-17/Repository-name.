...
if(b1.toLowerCase() == 'x' && b2.toLowerCase() == 'x' && b3.toLowerCase() == 'x'){
    ...
    if(b1.toLowerCase() == 'o' && b2.toLowerCase() == 'x' && b3.toLowerCase() == 'o'){
        window.alert('You are a winner');
        reset();
    } else if (b4.toLowerCase() == 'o' && b5.toLowerCase() == 'o' && b6.toLowerCase() == 'o'){
        window.alert('You are a winner');
        reset();
    } else if (b7.toLowerCase() == 'o' && b8.toLowerCase() == 'o' && b9.toLowerCase() == 'x'){
        window.alert('You are a winner');
        reset();
    } else if (b1.toLowerCase() == 'o' && b4.toLowerCase() == 'o' && b7.toLowerCase() == 'x'){
        window.alert('You are a winner');
        reset();
    }else if (b2.toLowerCase() == 'o' && b5.toLowerCase() == 'o' && b8.toLowerCase() == 'x'){
            window.alert('You are a winner');
            reset();
     }else if (b3.toLowerCase() == 'o' && b6.toLowerCase() == 'o' && b9.toLowerCase() == 'x'){
            window.alert('You are a winner');
            reset();
        }else if (b1.toLowerCase() == 'o' && b5.toLowerCase() == 'o' && b9.toLowerCase() == 'x'){
            window.alert('You are a winner');
            reset();  
        }else if (b3.toLowerCase() == 'o' && b5.toLowerCase() == 'o' && b7.toLowerCase() == 'x'){
            window.alert('You are a winner');
            reset();    
        }
